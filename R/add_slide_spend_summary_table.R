add_slide_spend_summary_table <- function(ppt, program, spend_summary, format1 = centurygothic8gray) {
  ...
  ppt <- officer::ph_with(x=ppt, value = spend_summary$flex_table, location = officer::ph_location(left=0.1,top=1,width = 9.5, height = 3.5))
